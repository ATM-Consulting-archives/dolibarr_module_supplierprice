 ...
 */
class supplierpricebox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "supplierprice@supplierprice";
    public $boxlabel;
    public $depends = array("supplierprice");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/supplierprice/class/supplierprice.class.php";
